...
public class VersionTest {
    ...
    void testEqualsAndHashCode() {
        ...
        assert !v1a.equals(v1c) : "Versions should not be equal if description is different";
        assert !v1a.equals(v1d) : "Versions should not be equal if downloadLink is different";
